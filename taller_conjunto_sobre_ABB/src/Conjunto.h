...
class Conjunto
{
    ...
    private:
        ...
        void insertarAux(const T& clave, Nodo* a);

        void removerAux(const T& clave, Nodo* a, Nodo* anterior);

        unsigned int cardinalAux(Nodo* a) const;

        bool perteneceAux(const T& clave, Nodo* a) const;
